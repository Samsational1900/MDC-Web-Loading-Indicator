# MDC-Loading-Indicator For Web      
      
A mdc-loading-indicator **Material Design–style loading indicator** built as a **Web Component** that works **natively in React and other frameworks**.      
